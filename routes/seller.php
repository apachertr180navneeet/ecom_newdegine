...
use App\Http\Controllers\Seller\CreditLimitController;
...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(GSTController::class)->group(function () {
       ...
       Route::controller(CreditLimitController::class)->group(function () {

        Route::get('/credit-limit','index')->name('credit.limit');

        Route::post('/add-credit','addCredit')->name('credit.add');
...
// PayU CALLBACK ROUTES (NO AUTH)
Route::match(['get','post'],'/seller/credit-success',
    [CreditLimitController::class,'paymentSuccess'])
    ->name('seller.credit.success');

Route::match(['get','post'],'/seller/credit-failed',
    [CreditLimitController::class,'paymentFailed'])
    ->name('seller.credit.failed');
