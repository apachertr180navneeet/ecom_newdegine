        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" id="aizSubmitForm" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        <label class="col-form-label">Listing For</label>
                        <select name="listing_for" class="form-control">
                            <option value="0" {{ $category->listing_for == 0 ? 'selected' : '' }}>Website</option>
                            <option value="1" {{ $category->listing_for == 1 ? 'selected' : '' }}>Seller</option>
                        </select>
                    </div>
                                       <div class="form-group mb-3">
